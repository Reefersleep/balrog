...
var i_27541 = (self__.level + (1));
while(true){
if((i_27541 <= (new_level + (1)))){
(update[i_27541] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_27545 = (update[i]).forward;
(x__$2.forward[i] = (links_27545[i]));
...
var i_27559 = (0);
while(true){
if((i_27559 <= self__.level)){
var links_27560 = (update[i_27559]).forward;
if((x__$1 === (((i_27559 < links_27560.length))?(links_27560[i_27559]):null))){
(links_27560[i_27559] = (x__$1.forward[i_27559]));

var G__27562 = (i_27559 + (1));
i_27559 = G__27562;
continue;
} else {
