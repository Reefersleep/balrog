...
var hx$hiccup$IElement$_as_element$dyn_26929 = (function (el,config){
...
return hx$hiccup$IElement$_as_element$dyn_26929(el,config);
}
});
...
while (G__26941__i < G__26941__a.length) {G__26941__a[G__26941__i] = arguments[G__26941__i + 0]; ++G__26941__i;}
  args = new cljs.core.IndexedSeq(G__26941__a,0,null);
} 
return hx$hiccup$parse_tag_$_VarEl__delegate.call(this,args);};
hx$hiccup$parse_tag_$_VarEl.cljs$lang$maxFixedArity = 0;
hx$hiccup$parse_tag_$_VarEl.cljs$lang$applyTo = (function (arglist__26942){
...
var fexpr__26909 = new cljs.core.Keyword(null,"create-element","create-element",193243064).cljs$core$IFn$_invoke$arity$1(config);
return (fexpr__26909.cljs$core$IFn$_invoke$arity$3 ? fexpr__26909.cljs$core$IFn$_invoke$arity$3(config,el,args) : fexpr__26909.call(null,config,el,args));
});
...
var a__$1 = this;
return hx.hiccup.make_element(config,new cljs.core.Keyword(null,"fragment","fragment",826775688).cljs$core$IFn$_invoke$arity$1(config),cljs.core.cons(null,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__26916_SHARP_){
return hx.hiccup._as_element(p1__26916_SHARP_,config);
}),a__$1)));
}));
...
return hx.hiccup.make_element(config,new cljs.core.Keyword(null,"fragment","fragment",826775688).cljs$core$IFn$_invoke$arity$1(config),cljs.core.cons(null,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__26919_SHARP_){
return hx.hiccup._as_element(p1__26919_SHARP_,config);
}),a)));
}));
...
if(cljs.core.truth_((function (){var fexpr__26928 = new cljs.core.Keyword(null,"is-element?","is-element?",-1231778016).cljs$core$IFn$_invoke$arity$1(config);
return (fexpr__26928.cljs$core$IFn$_invoke$arity$1 ? fexpr__26928.cljs$core$IFn$_invoke$arity$1(el) : fexpr__26928.call(null,el));
})())){
return el;
} else {
