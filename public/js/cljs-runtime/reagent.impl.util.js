...
var vec__34970 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(name_str,/-/);
...
var start = first__34972;
var parts = seq__34971__$1;
...
var self__ = this;
var self__ = this;
var G__34988 = (arguments.length - (1));
switch (G__34988) {
case (0):
...
(reagent.impl.util.PartialFn.prototype.apply = (function (self__,args34987){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args34987)));
}));
...
var _STAR_always_update_STAR__orig_val__35098 = reagent.impl.util._STAR_always_update_STAR_;
var _STAR_always_update_STAR__temp_val__35099 = true;
(reagent.impl.util._STAR_always_update_STAR_ = _STAR_always_update_STAR__temp_val__35099);

try{return (comp["forceUpdate"])();
}finally {(reagent.impl.util._STAR_always_update_STAR_ = _STAR_always_update_STAR__orig_val__35098);
}} else {
