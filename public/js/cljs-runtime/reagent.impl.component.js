...
if((i < len)){
var k = (ks[i]);
var G__35710 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__35711 = (i + (1));
m = G__35710;
i = G__35711;
continue;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__35600 = c;
var G__35600__$1 = (((G__35600 == null))?null:G__35600.prototype);
if((G__35600__$1 == null)){
return null;
} else {
return (G__35600__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__35606 = c;
var G__35606__$1 = (((G__35606 == null))?null:G__35606.prototype);
if((G__35606__$1 == null)){
return null;
} else {
return (G__35606__$1["render"]);
}
})() == null)))));
});
...
var G__35615 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__35615) : reagent.impl.component.as_element.call(null,G__35615));
};
...
var _STAR_current_component_STAR__orig_val__35617 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__35618 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__35618);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__35617);
}});
...
var c = this;
var G__35622_35719 = (c["cljsRatom"]);
if((G__35622_35719 == null)){
} else {
reagent.ratom.dispose_BANG_(G__35622_35719);
}
...
var renders_35720 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_35721 = cljs.core.first(cljs.core.vals(renders_35720));
if((cljs.core.count(renders_35720) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_35720))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_35721)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_35721], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__35659 = name;
switch (G__35659) {
case "":
...
var name = (function (){var G__35682 = fiber;
var G__35682__$1 = (((G__35682 == null))?null:(G__35682["type"]));
if((G__35682__$1 == null)){
return null;
} else {
return (G__35682__$1["displayName"]);
}
})();
var parent = (function (){var G__35684 = fiber;
if((G__35684 == null)){
return null;
} else {
return (G__35684["return"]);
}
})();
var path = (function (){var G__35686 = parent;
var G__35686__$1 = (((G__35686 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__35686) : reagent.impl.component.fiber_component_path.call(null,G__35686)));
if((G__35686__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__35686__$1)," > "].join('');
}
})();
...
var temp__5733__auto__ = (function (){var or__4126__auto__ = (function (){var G__35688 = c;
if((G__35688 == null)){
return null;
} else {
return (G__35688["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
return G__35689._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4126__auto__ = (function (){var G__35691 = c;
if((G__35691 == null)){
return null;
} else {
return (G__35691["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
var or__4126__auto____$1 = (function (){var G__35693 = c;
if((G__35693 == null)){
return null;
} else {
return G__35693._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4126__auto__ = (function (){var G__35695 = instance;
if((G__35695 == null)){
return null;
} else {
return (G__35695["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
var G__35696 = instance;
if((G__35696 == null)){
return null;
} else {
return G__35696._currentElement;
}
}
})();
var name = (function (){var G__35697 = elem;
var G__35697__$1 = (((G__35697 == null))?null:(G__35697["type"]));
if((G__35697__$1 == null)){
return null;
} else {
return (G__35697__$1["displayName"]);
}
})();
var owner = (function (){var or__4126__auto__ = (function (){var G__35699 = elem;
if((G__35699 == null)){
return null;
} else {
return (G__35699["_owner"]);
}
})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
return G__35700._owner;
}
}
})();
var path = (function (){var G__35701 = owner;
var G__35701__$1 = (((G__35701 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__35701) : reagent.impl.component.component_path.call(null,G__35701)));
if((G__35701__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__35701__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__35706 = c;
var G__35706__$1 = (((G__35706 == null))?null:G__35706.constructor);
if((G__35706__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__35706__$1);
}
}
})();
