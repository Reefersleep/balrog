...
var G__35717 = o;
(G__35717[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__35722 = o;
(G__35722[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__35754__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__35755__i < G__35755__a.length) {G__35755__a[G__35755__i] = arguments[G__35755__i + 0]; ++G__35755__i;}
  args = new cljs.core.IndexedSeq(G__35755__a,0,null);
} 
return G__35754__delegate.call(this,args);};
...
return G__35754__delegate(args);
});
...
var G__35725 = props;
var G__35725__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__35725,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__35725);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__35725__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__35726){
var map__35727 = p__35726;
var map__35727__$1 = (((((!((map__35727 == null))))?(((((map__35727.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__35727.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__35727):map__35727);
var props = map__35727__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35727__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__35729){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35730__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
var G__35733 = jsprops;
(G__35733["defaultValue"] = value);

(G__35733["onChange"] = (function (p1__35732_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__35732_SHARP_);
}));
...
var vec__35735 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35735,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35735,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35735,(2),null);
...
var jsprops = ({"argv": v});
var temp__5739__auto___35768 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___35768 == null)){
} else {
var key_35769 = temp__5739__auto___35768;
(jsprops["key"] = key_35769);
}
...
var temp__5739__auto___35770 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___35770 == null)){
} else {
var key_35771 = temp__5739__auto___35770;
reagent.impl.template.oset(jsprops,"key",key_35771);
}
...
var G__35739 = reagent.impl.template.__GT_NativeWrapper();
(G__35739["name"] = c);
...
var G__35740 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__35740) : reagent.impl.template.as_element.call(null,G__35740));
} else {
...
var len__4736__auto___35773 = arguments.length;
var i__4737__auto___35774 = (0);
while(true){
if((i__4737__auto___35774 < len__4736__auto___35773)){
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq35743){
...
break;
default:
var G__35796 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__35796;
continue;
...
var n__4613__auto___35806 = a.length;
var i_35807 = (0);
while(true){
if((i_35807 < n__4613__auto___35806)){
(a[i_35807] = reagent.impl.template.as_element((a[i_35807])));

var G__35808 = (i_35807 + (1));
i_35807 = G__35808;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4613__auto___35809 = a.length;
var i_35811 = (0);
while(true){
if((i_35811 < n__4613__auto___35809)){
var val_35812 = (a[i_35811]);
if(((cljs.core.vector_QMARK_(val_35812)) && ((reagent.impl.template.key_from_vec(val_35812) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_35811] = reagent.impl.template.as_element(val_35812));

var G__35816 = (i_35811 + (1));
i_35811 = G__35816;
continue;
} else {
}
...
var ctx = ({});
var vec__35747 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35747,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35747,(1),null);
...
var G__35750 = (cljs.core.count(argv) - first_child);
switch (G__35750) {
case (0):
